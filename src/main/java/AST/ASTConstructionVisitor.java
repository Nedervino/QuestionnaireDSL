...
//TODO define classes for binary and unary operations. When constructing the AST, make sure that each ExprNum is replaced with a ExprNumUnary, or ExprNumBinary. Do the same
